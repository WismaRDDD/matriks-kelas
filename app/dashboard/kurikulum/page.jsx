...
export default function KurikulumPage() {
  ...
  const fetchKurikulum = async (tahunId) => {
    ...
    try {
      ...
      const data = await res.json();
      // Filter berdasarkan tahun_akademik (f_tahun_akademik)
  ...
  useEffect(() => {
    // Set selectedKurikulum ketika kode_kurikulum dan tahun_ajaran dipilih
    if (selectedKodeKurikulum && selectedTahunAjaran) {
      const kurikulum = kurikulumList.find(
        (k) => k.kode_kurikulum === selectedKodeKurikulum && String(k.tahun_ajaran) === selectedTahunAjaran
      );
      if (kurikulum) {
        setSelectedKurikulum(kurikulum.id);
      }
    } else {
      setSelectedKurikulum('');
    }
      ...
      <div style={styles.card}>
        ...
        <div style={styles.tableWrapper}>
          <div style={styles.tableHeader}>
            <h2 style={styles.tableHeader}>📋 Daftar Mata Kuliah</h2>
            {selectedKurikulum && (
